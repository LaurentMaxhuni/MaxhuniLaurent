...
type TextureHalfFloatExtension = {
...
export function BlackHoleHeroSection({
  ...
  useEffect(() => {
    ...
    // dead canvas.
    const dbg = gl.getExtension("WEBGL_debug_renderer_info") as DebugRendererInfo | null;
    const renderer = dbg
    ...
    if (isGL2) {
      ...
      const hf = gl.getExtension("OES_texture_half_float") as TextureHalfFloatExtension | null;
